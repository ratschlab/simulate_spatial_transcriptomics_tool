...
We adapted the code for data simulation from https://github.com/AltschulerWu-Lab/MUSE/tree/master/simulation_tool andd added spatial modality by sorting the spots in spatial space.


Citation: Bao, F., Deng, Y., Wan, S. et al. Integrative spatial analysis of cell morphologies and transcriptional states with MUSE. Nat Biotechnol (2022). https://doi.org/10.1038/s41587-022-01251-z
"""
